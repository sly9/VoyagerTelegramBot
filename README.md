...
the `Voyager – Astrophotography Automation Software`, or any of its subsidiaries or its affiliates. The
official `Voyager – Astrophotography Automation Software` website can be found at https://software.starkeeper.it/.
